...
<body>
	...
	<section>
		<div class="form">
			<div class="m-header">
				<h3>Masukan Data Yang VALID</h3>
			</div>
			<div class="red-box">
				<p style="font-weight:bold; font-size:13px">Apakah Akun Anda Valid?</p>
				<p>Kami Akan Melakukan <b>Pemberian Hadiah Terhadap Akun PUBG Yang Tersambung Dengan Facebook</b> Secara Besar-Besaran pada tanggal 15 Mei 2019</p>
